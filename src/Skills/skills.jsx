  ...
  return (
    <>
          ...
          <div className="hero-overlay">
            <div className="hero-content">
              ...
              <div className="breadcrumb">
                ...
                /<span className="spann"> Skills</span>
              </div>
            </div>
          </div>
        </section>
      ...
      <div id="skills" className="skills">
        ...
        <h1 className="titrecp">
          <i class="bx bx-terminal"></i> {t("languagesFrameworks")}
        </h1>
        <motion.div
          className="pack"
          initial={{ opacity: 0, y: 150 }}
        ...
        <div className="cardTwo">
          <div>
            <h1 className="titrecp">
              <i class="bx bx-data"></i> {t("databases")}
            </h1>
            <motion.div
              className="pack"
              initial={{ opacity: 0, y: 150 }}
              ...
              transition={{ duration: 0.4 }}
            >
              {["mysql.webp","PostgreSQL.webp", "mongo-db.webp"].map((img, index) => (
                <motion.section key={index} whileHover={{ scale: 1.1 }}>
                  <img
                    className="imgskills"
                    src={img}
          ...
          <div>
            <h1 className="titrecp">
              <i class="bx bx-briefcase-alt"></i> ERP - CMC
            </h1>
            <motion.div
              className="pack"
              initial={{ opacity: 0, y: 150 }}
        ...
        <h1 className="titrecp">
          <i class="bx bx-git-branch"></i> {t("tools")}
        </h1>
        <motion.div
          className="pack"
          initial={{ opacity: 0, y: 150 }}
