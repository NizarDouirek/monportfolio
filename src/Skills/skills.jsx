  ...
  return (
    ...
    <div id="skills" className="skills">
      ...
      <motion.div className="pack" initial={{ opacity: 0, y: 150 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4}}>
        {["html.avif", "css.avif","bootstrap.avif", "javascript.webp", "php.webp", "java.png", "react.webp","react-native.webp", "laravel.webp","python.png"].map((img, index) => (
      ...
      <motion.div className="pack" initial={{ opacity: 0, y: 150 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        {[ "git.webp","github.webp", "postman.webp","docker.webp","xamp.webp","figma.webp", "canva.webp","grafana.png", "photoshop.webp"].map((img, index) => (
          <motion.section key={index} whileHover={{ scale: 1.1 }}>
            <img loading="lazy" className="imgskills" src={img} alt={img.split(".")[0]} />
            <h2>{img.split(".")[0].toUpperCase()}</h2>
          </motion.section>
