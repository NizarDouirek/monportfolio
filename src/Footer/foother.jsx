  ...
  return (
    <footer className="footer" role="contentinfo" itemScope itemType="http://schema.org/WPFooter">
      <div className="social" role="navigation" aria-labelledby="social-heading">
        ...
        <a className="twit"  href="https://x.com/hicham588696564" aria-label="Twitter" target="_blank" rel="noopener noreferrer">
          <i className="fa-brands fa-x-twitter"></i>
        </a>
        <a className="linkdeen"
...
>
  <i className="fa-brands fa-linkedin-in"></i>
        ...
        <a className="insta" href="https://www.instagram.com/nizar_douirek" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
...
>
  <i className="fa-brands fa-github"></i>
      ...
      <ul className="footer-links" role="navigation" aria-labelledby="footer-links-heading">
        ...
        <li><a href="homme">Acceuil</a></li>
        <li><a href="about">A propos</a></li>
        <li><a href="skills">compétance</a></li>
        <li><a href="projet">Projet</a></li>
        <li><a href="Cv">CV</a></li>
        <li><a href="contact">Contact</a></li>
      </ul>
      <p className="copyright">copyright © Mon Portfolio 2024 <br />
      NIZAR DOUIREK
      </p>
    </footer>
  );
