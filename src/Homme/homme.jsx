...
export default function Homme() {
   ...
   const carousel = document.getElementById('skillsCarousel');
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Active le premier élément par défaut
