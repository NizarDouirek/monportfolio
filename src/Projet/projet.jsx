...
export default function Projet({ showHero = true }) {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.5 },
    ); // Déclenche lorsque 50% de l'élément est visible (ajout de .sectionP8 pour que l'animation soit appliquée)
  ...
  return (
    <>
          ...
          <div className="hero-overlay">
            <div className="hero-content">
              ...
              <div className="breadcrumb">
                ...
                /<span className="spann"> Project</span>
              </div>
            </div>
          </div>
        </section>
            ...
            <br />
             ...
             <div className="sectionTchatoo">
              <div className="contentP">
                ...
                <div className="nbv">
                  <a
                    href="https://github.com/NizarDouirek/Tchatoo"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <button className="visitTchatoo">
                      <svg
                        class="github-icon"
                        viewBox="0 0 24 24"
                        fill="currentColor"
      ...
      C20.57,22.38,24,17.88,24,12.5C24,5.87,18.63,0.5,12,0.5z"
                  ...
                  <a
                    href="https://tchatoo-seven.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="visit-icon-btn"
                  >
            ...
            <div className="sectionP8">
              <div className="contentP">
                ...
                <div className="nbv">
                  <a
                    href="https://safetyambassadorprogramm.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <button className="visit8">
                      <svg
                        class="github-icon"
                        viewBox="0 0 24 24"
                        fill="currentColor"
